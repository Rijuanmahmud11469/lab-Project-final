...

{
	...
	printf("\xbd\t\t\t\t\xbd\tRIJUAN CLOTHING STORE\t \xbd\t\t\t\t\t\t\xbd\n");
	printf("\xbd\t\t\t\t\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\t\t\t\t\t\t\xbd\n");
	printf("\xbd\t\t\t\t          Contact Info:01951209188     \t\t\t\t\t\t\t\xbd\n");
...
void login()
{
  ...
  while(i<32)
	{
	    password[MAX_PASSWORD_LEN]=getch();
	    c=password[MAX_PASSWORD_LEN];
	    if(c==13) break;
	    else printf("*");
	    i++;
	}
